...
class DoxygenAwesomeFragmentCopyButton extends HTMLElement {
    ...
    static init() {
        // OPERATOR PATCH: ported off jQuery to vanilla JS (Doxygen 1.14+ ships no
        // jQuery, so the original `$(function(){...})` threw and copy buttons never
        // appeared). Behaviour is unchanged: on DOM-ready, wrap every code fragment
        // and add a copy button when the Clipboard API is available.
